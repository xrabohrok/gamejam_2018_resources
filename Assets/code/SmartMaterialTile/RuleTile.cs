...
namespace UnityEngine
{
    ...
    public class RuleTile : TileBase
    {
        ...
        public bool m_smartMaterial;
        public Sprite m_smartMaterialSource;
        public Sprite m_smartMaterialSource_old;

        [Serializable]
        public class TilingRule
        {
            //rule definition for neighbors
            //0 is the top left, 7 is the bottom right, (1,1) or 5 is the center is actually skipped so 5 is middle right
