...
using Neighbor= UnityEngine.RuleTile.TilingRule.Neighbor; 
...
namespace UnityEditor
{
    ...
    internal class RuleTileEditor : Editor
    {
        ...
        private class smartRule
        {
            //if you start top-left at zero and wrap around...
            public int bottomLeftIndex;
            public Neighbor[] neighborRules;
            public string name;

        }

        private smartRule[] allSmartRules =
            {
                //top left corner
                new smartRule
                {
                    ...
                    neighborRules =new[]
                    {
                        Neighbor.NotThis, Neighbor.NotThis, Neighbor.DontCare,
                        Neighbor.NotThis, /*center skip*/   Neighbor.This,
                        Neighbor.DontCare, Neighbor.This,    Neighbor.This
                    },
                    name = "top_left"
                },
                //middle top edge
                new smartRule
                {
                    ...
                    neighborRules =new[]
                    {
                        Neighbor.DontCare, Neighbor.NotThis, Neighbor.DontCare,
                        Neighbor.This,    /*center skip*/   Neighbor.This,
                        Neighbor.DontCare, Neighbor.This,    Neighbor.DontCare
                    },
                    name = "top_middle"
                },
                //top right corner
                new smartRule
                {
                    ...
                    neighborRules =new[]
                    {
                        Neighbor.DontCare, Neighbor.NotThis, Neighbor.NotThis,
                        Neighbor.This,    /*center skip*/   Neighbor.NotThis,
                        Neighbor.DontCare, Neighbor.This,    Neighbor.DontCare
                    },
                    name = "top_right"
                },
                ...
                //center would go here but it must evaluate LAST
                //right edge
                new smartRule
                {
                    bottomLeftIndex = 29,
                ...
                new smartRule
                {
                    ...
                    neighborRules =new[]
                    {
                        Neighbor.NotThis, Neighbor.This, Neighbor.DontCare,
                        Neighbor.This,    /*center skip*/   Neighbor.This,
                        Neighbor.DontCare, Neighbor.This,    Neighbor.DontCare
                    },
                    name = "concave_1"
                ...
                new smartRule
                {
                    ...
                    neighborRules =new[]
                    {
                        Neighbor.DontCare, Neighbor.This, Neighbor.NotThis,
                        Neighbor.This,    /*center skip*/   Neighbor.This,
                        Neighbor.DontCare, Neighbor.This,    Neighbor.DontCare
                    },
                    name = "concave_2"
        ...
        {
            tile.m_smartMaterial = EditorGUILayout.Toggle("Is Smart Material", tile.m_smartMaterial);
            if (tile.m_smartMaterial)
            {
                tile.m_smartMaterialSource = EditorGUILayout.ObjectField("Smart Material Source",
                    tile.m_smartMaterialSource, typeof(Sprite), false) as Sprite;
            ...
            if (tile.m_smartMaterialSource != tile.m_smartMaterialSource_old)
            {
                splitUpSmartMaterial();
                tile.m_smartMaterialSource_old = tile.m_smartMaterialSource;
            }
        }
